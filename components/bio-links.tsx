...
import { Instagram, Twitter, Linkedin, Youtube, Mail, Globe, FileText, Shield, Wallet, Package, Receipt } from "lucide-react"
    ...
    <div className="min-h-screen bg-gradient-to-br from-primary/5 via-background to-accent/5" dir="rtl">
      <div className="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <div className="text-center mb-8 animate-fade-in">
          <div
            className="w-32 h-32 mx-auto mb-6 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center text-white text-4xl font-bold shadow-lg animate-scale-in"
            style={{
        ...
        <div className="space-y-4 mb-8">
          {links.map((link, index) => {
            ...
            return (
              ...
              >
                <Card className="p-6 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 bg-card border-border hover:border-primary/50 group">
